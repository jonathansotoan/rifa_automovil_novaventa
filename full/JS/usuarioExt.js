...
var selectedCellColor = '#java:selectedCellColor';
//var cellsColor = '#java:cellsColor';//deprecated: cellsColor
var bordersColor = '#java:bordersColor';
var textColor = '#java:textColor';
var rowsQuantity = #java:rowsQuantity;
var columnsQuantity = #java:columnsQuantity;

var selectedCells = new Array();

var currentIndex = 0;

var names = #java:names;
var chances = #java:chances;
var colors = #java:colors;
...
function mouseOverEffect( idCol ) {
	...
	for( j = 0; j < selectedCells[ currentIndex ][ 2 ].length; ++j )
		$( '#' + selectedCells[ currentIndex ][ 2 ][ j ] ).css( 'background-color', selectedCells[ currentIndex ][ 3 ] );
}
